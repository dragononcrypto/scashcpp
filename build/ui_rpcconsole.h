...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Scash - Debug window", 0, QApplication::UnicodeUTF8));
        label_9->setText(QApplication::translate("RPCConsole", "Scash Core", 0, QApplication::UnicodeUTF8));
        ...
        clientVersion->setText(QApplication::translate("RPCConsole", "1.0.0", 0, QApplication::UnicodeUTF8));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Scash debug log file from the current data directory. This can take a few seconds for large log files.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the scash-qt help message to get a list with possible Scash command-line options.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
