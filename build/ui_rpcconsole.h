...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Scash - Debug window", nullptr));
        label_9->setText(QApplication::translate("RPCConsole", "Scash Core", nullptr));
        ...
        clientVersion->setText(QApplication::translate("RPCConsole", "1.0.0", nullptr));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Scash debug log file from the current data directory. This can take a few seconds for large log files.", nullptr));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the scash-qt help message to get a list with possible Scash command-line options.", nullptr));
#endif // QT_NO_TOOLTIP
